...
Want to help make `uglify_hs` faster, want to help expand the `uglify_hs` binary
...
Documentation is an important part of any project and `uglify_hs` is no
...
If you're here then you've probably encountered an issue with `uglify_hs`,
...
- What happened?
- What steps did you take with `uglify_hs` to try to make that happen?
